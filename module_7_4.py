...
# Использование format():
print("Команда %s решила задач: %d!" % (team2, score_2))
print("Команда %s решила задач: %d!" % (team1, score_1))
print("Волшебники данных решили задач за %.2fс!" % team2_time)
print("Мастера кода решили задач за %.2fс!" % team1_time)
